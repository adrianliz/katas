...
public class TennisGame4 implements TennisGame {
  ...
  public void wonPoint(String playerName) {
    if (server.equals(playerName)) this.serverScore += 1;
        ...
        new Deuce(
                ...
                new GameServer(
                    ...
                    new GameReceiver(
                        this,
                        new AdvantageServer(
                            this, new AdvantageReceiver(this, new DefaultResult(this))))))
            .getResult();
...
class TennisResult {
  ...
  String format() {
    if ("".equals(this.receiverScore)) return this.serverScore;
    if (serverScore.equals(receiverScore)) return serverScore + "-All";
...
class Deuce implements ResultProvider {
  ...
  public TennisResult getResult() {
    if (game.isDeuce()) return new TennisResult("Deuce", "");
...
class GameServer implements ResultProvider {
  ...
  @Override
  public TennisResult getResult() {
    if (game.serverHasWon()) return new TennisResult("Win for " + game.server, "");
    return this.nextResult.getResult();
  }
}
...
class GameReceiver implements ResultProvider {
  ...
  @Override
  public TennisResult getResult() {
    if (game.receiverHasWon()) return new TennisResult("Win for " + game.receiver, "");
    return this.nextResult.getResult();
  }
}
...
class AdvantageServer implements ResultProvider {
  ...
  @Override
  public TennisResult getResult() {
    if (game.serverHasAdvantage()) return new TennisResult("Advantage " + game.server, "");
    return this.nextResult.getResult();
  }
}
...
class AdvantageReceiver implements ResultProvider {
  ...
  @Override
  public TennisResult getResult() {
    if (game.receiverHasAdvantage()) return new TennisResult("Advantage " + game.receiver, "");
    return this.nextResult.getResult();
  }
}
